    ...
    <>
      ...
      <section className="w-full min-h-screen bg-white text-black flex flex-col md:flex-row items-start justify-between p-6 sm:p-8 md:p-10 gap-10">
        ...
        <div className="w-full md:flex-1">
          ...
          <p className="text-gray-600 mt-6 leading-relaxed w-full sm:w-[90%]">
        ...
        <form
          onSubmit={sendForm}
          className="w-full md:flex-1 rounded-3xl p-6 sm:p-8 bg-gray-50 shadow-sm mt-6 sm:mt-10 md:mt-12 flex flex-col gap-4"
        >
          <input
            name="name"
            value={form.name}
          ...
          <textarea
            ...
            rows="5"
            className="w-full p-3 border border-gray-300 rounded-xl h-80 resize-none"
          />
