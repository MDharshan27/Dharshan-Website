  ...
  return (
    <>
      ...
      <section className="w-full min-h-screen bg-white text-black flex flex-col ">
        ...
        {/* ===== Top Row ===== */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center p-6 sm:p-8 md:p-10 gap-10">
          ...
          <div
            ...
            onMouseLeave={() => gsap.to("#cursor", { scale: 1, duration: 0.3 })}
            className="mt-6 sm:mt-10 md:mt-12 w-full md:w-[420px] bg-[#0b0b0b] text-white rounded-2xl p-6 flex flex-col justify-between"
          >
        ...
        {/* ===== Middle Section ===== */}
        <div className="mt-8 md:mt-12 flex flex-col md:flex-row justify-center items-stretch gap-6 md:gap-8 p-6 sm:p-8 md:p-10">

          {/* Left Side */}
          <div className="flex flex-col gap-6 rounded-3xl w-full md:w-[500px]">
